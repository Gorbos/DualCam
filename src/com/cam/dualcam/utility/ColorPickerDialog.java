...
public class ColorPickerDialog extends Dialog {
    ...
    public static TextView toBeColoredView = null;
    ...
    private static class ColorPickerView extends View {
        ...
        ColorPickerView(Context c, OnColorChangedListener l, int color) {
            ...
            mColors = new int[] { 0xFFFF0000, 0xFFFF00FF, 0xFF0000FF,
                    0xFF00FFFF, 0xFF00FF00, 0xFFFFFF00, 0xFFFF0000, 0xFF000000, 0xFFFFFF,};
        ...
        public boolean onTouchEvent(MotionEvent event) {
            ...
            case MotionEvent.ACTION_DOWN:
                ...
                if (inCenter) {
                    ...
                    toBeColoredView.setTextColor(mCenterPaint.getColor());
                    invalidate();
                    break;
                }
            ...
            case MotionEvent.ACTION_UP:
                if (mTrackingCenter) {
                    if (inCenter) {
                        ...
                        //toBeColoredView = new TextView(getContext());
                        toBeColoredView.setTextColor(mCenterPaint.getColor());
                    }
    ...
    public ColorPickerDialog(Context context, OnColorChangedListener listener,
            int initialColor, TextView view) {
        super(context);

        mListener = listener;
        mInitialColor = initialColor;
        toBeColoredView = view;
    }
